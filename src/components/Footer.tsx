export function Footer() {
  return (
    <footer className="mt-24 border-t border-white/5 bg-ink/60">
      ...
      <div className="border-t border-white/5 py-4 text-center text-xs text-chalk/40">
...
function FooterCol({ title, items }: { title: string; items: string[] }) {
  return (
    <div>
      <div className="text-xs font-semibold uppercase tracking-wide text-chalk/60">
        {title}
      </div>
